...
public class Accommodation extends BaseTimeEntity {
  ...
  private Accommodation(TripPlan tripPlan, String nameOrAddress, LocalDate checkinDate,
  ...
  public static Accommodation create(TripPlan tripPlan, String nameOrAddress,
    ...
    return new Accommodation(tripPlan, nameOrAddress, checkinDate, checkoutDate);
  }
}
