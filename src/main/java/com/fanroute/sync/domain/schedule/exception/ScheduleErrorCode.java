...
public enum ScheduleErrorCode implements BaseCode {
  ...
  AI_ITINERARY_GENERATION_UNAVAILABLE_ON_CONCERT_DAY(HttpStatus.BAD_REQUEST,
      "SCHEDULE_AI_ITINERARY_GENERATION_UNAVAILABLE_ON_CONCERT_DAY", "공연일에는 AI 일정을 생성할 수 없습니다."),
  AI_ITINERARY_GENERATION_LIMIT_EXCEEDED(HttpStatus.TOO_MANY_REQUESTS,
      "SCHEDULE_AI_ITINERARY_GENERATION_LIMIT_EXCEEDED", "AI 추천 횟수를 모두 사용했습니다."),
