 ...
 * <p>
 * {@code application.yml}의 {@code external-api} 하위 설정을 변환하여 HTTP Client 설정과 서비스별 Base URL에 사용합니다.
 * </p>
 */
@Getter
@Validated
...
public class ExternalApiProperties {
  ...
  private final Map<String, Service> services = new HashMap<>(); // Key: 외부 서비스 이름, Value: 내용
